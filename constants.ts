...
export const TODO_LIST: ChecklistItem[] = [
  ...
  { id: 'todo_4', text: 'プラネタリア訂票　場次 13:10' },
];
...
export const USEFUL_LINKS: UsefulLink[] = [
  ...
  { title: '下北澤古著地圖（9/27）', url: 'https://claude.ai/artifact/YJ2bAosJJ7ZAvTb5ikK9yu' },
  { title: 'ムーンアートナイト 全作品', url: 'https://moonartnightfes.com/artwork/' },
...
export const VOUCHERS: Voucher[] = [
  { name: '虎航 IT210 TPE→KIX　想想', url: 'https://drive.google.com/file/d/1Gxs5mmehV3QUuGpsofVDsmOJ-bKSXCwg/view', type: 'ticket' },
  { name: '虎航 IT206 TPE→NGO　Yian', url: 'https://drive.google.com/file/d/1ICzFaSc9dgZaAoN4nqwYjc10KpX2z26t/view', type: 'ticket' },
  { name: '南海電鐵（Klook・未劃位）', url: 'https://drive.google.com/file/d/1ktRS_ocwUxZtHq_aqx3_UZfqJY0dSL4p/view', type: 'train' },
  { name: '名古屋 飯店訂房', url: 'https://drive.google.com/file/d/1BDD0Y1Nu13TfJIU8htOdT4VI85CBYp6p/view', type: 'hotel' },
  ...
  { name: '新幹線 名古屋→品川　Yian', url: 'https://drive.google.com/file/d/14SKJnjnvWAQdC8sh84bG-2-iGhkERijf/view', type: 'train' },
  { name: '大井町 飯店訂房', url: 'https://drive.google.com/file/d/1VStByV9HAJrSIwXmBm1Vrp9DPcDb16mv/view', type: 'hotel' },
  { name: '行李寄送須知', url: 'https://drive.google.com/file/d/1kp7-5GVo6dWz7XTZxDQacIid_4lK-u95/view', type: 'ticket' },
  { name: 'Skyliner 京成上野→成田', url: 'https://drive.google.com/file/d/1dGCOkT8mJSausVwnRgWdIfqGQyEKb0y_/view', type: 'train' },
  { name: '長榮 BR195 NRT→TPE　回程', url: 'https://drive.google.com/file/d/1PqUklYXN_AjjGfQG2-uFR6qjF6hLSvnp/view', type: 'ticket' },
];

/* 天氣：行程橫跨三個城市，依當天日期自動切換 */
/** '9/23' → '2026-09-23'。行程用短日期，天氣 API 與「今天是第幾天」需要 ISO。 */
export const toTripIso = (shortDate: string): string => {
  const [month, day] = shortDate.split('/');
  return `2026-${month.padStart(2, '0')}-${day.padStart(2, '0')}`;
};

/** 每天待的城市各查一次天氣。9/24 整天在飛驒山區，跟名古屋可以差 5-6 度，不能共用。 */
export const WEATHER_SPOTS: WeatherSpot[] = [
  { date: '9/23', label: '名古屋', latitude: 35.1815, longitude: 136.9066 },
  { date: '9/24', label: '白川鄉', latitude: 36.2578, longitude: 136.9061 },
  { date: '9/25', label: '名古屋', latitude: 35.1815, longitude: 136.9066 },
  { date: '9/26', label: '東京', latitude: 35.6785, longitude: 139.6823 },
  { date: '9/27', label: '東京', latitude: 35.6785, longitude: 139.6823 },
  { date: '9/28', label: '橫濱', latitude: 35.4437, longitude: 139.6380 },
  { date: '9/29', label: '東京', latitude: 35.6785, longitude: 139.6823 },
];
...
export const LOCATION_DETAILS: Record<string, LocationDetail> = {
  ...
  'unafuji': {
    id: 'unafuji',
    title: 'うな富士 名古屋駅太閤口店',
    description: '已訂位 19:00。離近鐵和飯店都很近，解散後可以先回飯店放東西再出來。\n中午到晚上連續營業，白川鄉回程若延誤，提早打電話通知還來得及。',
    openingHours: '11:00–22:00（L.O. 21:00）｜不定休',
  ...
  'nihao_keishinkaku': {
    id: 'nihao_keishinkaku',
    title: '你好 恵馨閣（ニイハオ）',
    description: '蒲田名物羽根つき餃子。蒲田車站徒步 3 分，跟會場同一側（西蒲田）。\n全年無休、開到半夜 12 點，所以活動不管幾點散場都吃得到。',
    openingHours: '11:00–24:00，全年無休',
    address: '東京都大田区西蒲田7-45-1 イプセ蒲田 2F',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=%E4%BD%A0%E5%A5%BD%20%E6%81%B5%E9%A6%A8%E9%96%A3%20%E8%92%B2%E7%94%B0',
  },
  'nabeya_sakuragicho': {
    id: 'nabeya_sakuragicho',
    title: '鍋専科 鍋屋 横浜店',
    description: '涮涮鍋與壽喜燒，有みなとみらい夜景座位。在コレットマーレ 7F——就是你逛 .st 的同一棟，逛完搭電梯上去。\n桜木町駅北改札直結，徒步 1 分。想要夜景座位最好先訂（045-323-9081）。官網訂位頁 9/28 顯示可直接預約。\n⚠️ 只訂座位的話，當天 10:00 之後取消每人收 ¥3,000。',
    openingHours: '11:00–15:00／17:00–22:00（料理 L.O. 21:00）｜全年無休',
    address: '神奈川県横浜市中区桜木町1-1-7 コレットマーレ 7F',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=%E9%8D%8B%E5%B0%82%E7%A7%91%20%E9%8D%8B%E5%B1%8B%20%E6%A1%9C%E6%9C%A8%E7%94%BA',
  },
  'b_squared': {
    id: 'b_squared',
    title: 'B²（ビースクエアード）清澄白河本店',
    description: '天然酵母麵包與自家烘焙咖啡。\n⚠️ 地址在深川 1-9-10，離門前仲町站比清澄白河站近——從清澄白河 A3 出口走過去要 8–10 分。大江戸線在清澄白河前一站就是門前仲町，可以考慮提早一站下車。',
  ...
  'shimokita_akichi': {
    id: 'shimokita_akichi',
    title: 'Museum of the Moon ＠下北線路街 空き地',
    description: '英國藝術家 Luke Jerram 的作品，直徑七公尺，表面是 NASA 拍的月面影像，約五十萬分之一——球體上的一公分等於月球上的五公里，內部打光。\n屬於「ムーンアートナイト下北沢 2026」（9/18–10/4）的主要作品。\n⚠️ 15:00–20:00 免費、任何人都能看；20:00 之後才要門票，21:00 起有線香花火。\n藝術祭近日有因天候中止的公告（9/20、9/21 都發過），出門前看一下官網 NEWS。\n東口往下北沢交番方向徒步 4 分。',
    openingHours: '展示 15:00–21:30（15:00–20:00 免費時段）',
    address: '東京都世田谷区北沢2-33-12',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=%E4%B8%8B%E5%8C%97%E7%B7%9A%E8%B7%AF%E8%A1%97%20%E7%A9%BA%E3%81%8D%E5%9C%B0',
  },
  'chopsticks_mikan': {
    id: 'chopsticks_mikan',
    title: 'チョップスティックス ＠ミカン下北',
    description: '日本第一家生米麵フォー，午間是河粉套餐（附越式雞飯、生春捲）。\n選它的理由是快：就在車站高架下、零步行，麵食上得快，還有外帶櫃檯可以買越式法包邊走邊吃。省下來的時間全部給古著。\n不定休——同棟 A 街區還有十幾家（タイ屋台999 A-207、台灣焼小籠包 ダパイダン105、韓食ハヌリ），撲空就換一家。',
    openingHours: '週日 11:30–15:00（L.O. 14:30）｜不定休',
    address: '東京都世田谷区北沢2-11-15 ミカン下北 A-206',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=%E3%83%81%E3%83%A7%E3%83%83%E3%83%97%E3%82%B9%E3%83%86%E3%82%A3%E3%83%83%E3%82%AF%E3%82%B9%20%E4%B8%8B%E5%8C%97%E6%B2%A2',
  },
  'osu_kannon': {
    id: 'osu_kannon',
  ...
  'bucyo_coffee': {
    id: 'bucyo_coffee',
    title: 'Bucyo Coffee',
    description: '招牌小倉トースト。7:15 就開，早餐時段很寬裕。\n⚠️ 官網地址是中村区名駅南 1-10-9，在車站南側，跟飯店所在的椿町隔著站體——不是原本寫的「太閤通口周邊步行 5–8 分」。出發前用地圖抓一次實際時間。',
    openingHours: '7:15–17:00｜無休',
    address: '愛知県名古屋市中村区名駅南1-10-9 山善ビル1F',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=BUCYO%20COFFEE%20%E5%90%8D%E9%A7%85%E5%8D%971-10-9',
  },
  'kiyosu_castle': {
    id: 'kiyosu_castle',
    title: '清洲城',
  ...
  'rockin_robin': {
    id: 'rockin_robin',
    title: 'ロッキンロビン 大須店',
    description: '午餐。鐵板漢堡排，在大須第2アメ横ビル 3F。\n11:30 才開門，13:00 到沒問題，但沒辦法更早。',
    openingHours: '11:30–23:00（料理 L.O. 22:00）｜無休',
    address: '愛知県名古屋市中区大須3-14-43 大須第2アメ横ビル3F',
  ...
  'kurin': {
    ...
    openingHours: '11:00–19:00（L.O. 18:30）｜木曜定休（9/25 週五營業）',
  ...
  'horaiken_honten': {
    id: 'horaiken_honten',
    title: 'あつた蓬萊軒 本店',
    description: '不收電話訂位，只能現場登記。整理券約 10:00–10:30 開始發，忙的日子會提前。有人 9:40 到時前面已經好幾組，週六＋亞運再提前一點比較安全。\n備案：整理券若排到 13:00 以後，改去神宮店（午餐 L.O. 14:30、火曜與第2・第4月曜公休，9/26 也有開）或改買外帶。\n⚠️ 本店午餐 L.O. 14:00，混雜時會提早收單。',
    openingHours: '11:30–14:00（L.O.）／16:30–20:30（L.O.）｜定休 水曜・第2・第4木曜（9/26 週六營業）',
  ...
  'naruto_taiyaki': {
    id: 'naruto_taiyaki',
    title: '鳴門鯛焼本舗 蒲田駅前店',
    description: '⚠️ 在 JR 蒲田駅**東口**、幾乎站體直結；會場在**西口**，兩邊相反，中間要穿過車站約 5 分。\n15:46 到站先出東口買，吃完再穿到西口進場，30 分鐘夠用。10:00 開到隔天清晨 5:00、年中無休，散場後再買也可以。\n場內能不能飲食要看主辦方的注意事項，所以排在進場前。',
    openingHours: '10:00–翌 05:00｜年中無休',
    address: '東京都大田区蒲田',
  ...
  'center_beef': {
    ...
    description: '11:00 開店，午市到 15:00。只有約 10 席會等一下。從掃部山走下來約 18 分。\n9/28 是週一，有平日限定的 ¥880 午餐與白飯免費加大。不定休，出發前確認當天有無休息。',
    openingHours: '週一～四 11:00–15:00／17:30–21:15｜不定休',
  ...
  'planetaria': {
    ...
    description: '橫濱Gate Tower 2F，新高島站 1 號出口步行 1 分。\n9/28 的場次已確認是 13:10，跟原本排的一樣，後面整串不用動。\n⚠️ 訂票 9/23 才開放（開演五天前），開賣當天就去訂——這是熱門時段。',
    openingHours: '9/28 場次 13:10–13:50（訂票 9/23 開放）',
...
export const ITINERARY: DaySchedule[] = [
  {
    ...
    weekday: '星期三',
    title: '抵達名古屋・名古屋城夜祭',
    accommodation: '名古屋 飯店',
    accommodationMapUrl: 'https://www.google.com/maps/search/?api=1&query=%E5%90%8D%E5%8F%A4%E5%B1%8B%E9%A7%85',
    ...
    events: [
      ...
      { time: '11:20', description: '機場買午餐帶上車', category: 'food', note: '入境後到上車只有 15 分，午餐在 KIX 解決' },
      ...
      { time: '15:10', description: '入住飯店', category: 'stay', locationId: 'via_inn_nagoya' },
      ...
      { time: '17:30', description: '名古屋城 大盆踊り大会（晚餐吃屋台）', category: 'event', locationId: 'nagoya_castle', isHighlight: true, note: '17:30–19:10。晚餐直接在城內屋台解決：手羽先唐揚げ、みそかつ串、名古屋コーチン唐揚げ。18:00 平針木遣り音頭' },
      { time: '19:20', description: 'AICHI NAGOYA ART&LIGHTS', category: 'event', locationId: 'art_lights', note: '免費免預約，18:30–19:30 最擠，這時間去剛好錯開' },
      { time: '20:10', description: '回飯店', category: 'transit', note: '晚餐已在城內屋台吃過' },
    ]
  },
  {
    date: '9/24',
    ...
    events: [
      { time: '07:30', description: '超商早餐', category: 'food', note: '飯店 1F 早餐 6:30 開始，看方案有沒有含' },
      ...
      { time: '19:00', description: 'うな富士 太閤口店（上ひつまぶし）', category: 'food', locationId: 'unafuji', isHighlight: true, note: '已訂位。巴士若明顯延遲先通知店家' },
  ...
  },
  {
    ...
    events: [
      { time: '08:25', description: 'Bucyo Coffee 早餐（小倉トースト）', category: 'food', locationId: 'bucyo_coffee', note: '08:25–09:10' },
      ...
      { time: '13:00', description: 'Rockin\' Robin 大須店（ミニバーガー）', category: 'food', locationId: 'rockin_robin', note: '13:00–13:50' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '17:20', description: '抵達朋友家', category: 'stay', locationId: 'maiya_kunitachi' },
      { time: '18:30', description: '朋友家晚餐', category: 'food' },
    ]
  },
  {
    date: '9/27',
    ...
    accommodation: '大井町 飯店',
    accommodationMapUrl: 'https://www.google.com/maps/search/?api=1&query=%E5%A4%A7%E4%BA%95%E7%94%BA%E9%A7%85',
    mapUrl: 'https://www.google.com/maps/dir/Kunitachi+Station/Gotokuji+Temple/Shimokitazawa/Shimokitazawa+Senrogai+Akichi/Shinagawa+Station/Nihon+Kogakuin+Kamata/Oimachi+Station',
    links: [{ label: '古著地圖', url: 'https://claude.ai/artifact/YJ2bAosJJ7ZAvTb5ikK9yu' }],
    events: [
      { time: '09:00', description: '朋友家早餐', category: 'food' },
      { time: '10:30', description: '離開朋友家', category: 'stay', note: '要趕 11:30 到豪德寺就得 10:30 出門，路上 50 分鐘' },
      ...
      { time: '12:30', description: 'チョップスティックス 午餐（河粉）', category: 'food', locationId: 'chopsticks_mikan', note: '～13:10。ミカン下北 A-206，出站不用走' },
      { time: '13:15', description: '下北澤 古著巡禮', category: 'spot', locationId: 'shimokitazawa', note: '～15:00。GASLAMP → Flamingo → BIG TIME(2F) → MONK → MICMO，見古著地圖' },
      { time: '15:00', description: 'Museum of the Moon ＠空き地', category: 'event', locationId: 'shimokita_akichi', isHighlight: true, note: '～15:20。15:00 才亮相，免費時段到 20:00' },
      { time: '15:30', description: '下北沢 → 品川 16:00', category: 'transit', note: '為了等月亮往後挪 30 分，蒲田那邊仍來得及', origin: '下北沢', legs: [{ via: '井の頭線', to: '渋谷' }, { via: '山手線', to: '品川', arrive: '16:00' }] },
      { time: '16:05', description: '品川 → 蒲田 16:16', category: 'transit', note: '行李續留品川置物櫃，活動後再回頭拿', origin: '品川', legs: [{ via: '京浜東北線', to: '蒲田', arrive: '16:16' }] },
      { time: '16:20', description: '鳴門鯛焼本舗 蒲田駅前店', category: 'food', locationId: 'naruto_taiyaki', note: '東口站邊，買了在場外吃掉再穿到西口' },
      { time: '16:40', description: '抵達片柳アリーナ', category: 'transit', locationId: 'kogakuin_arena', note: '穿到西口徒步 2 分。入口在 2 号館，電扶梯往下：B3 是 2 樓席、B4 是搖滾區' },
      { time: '17:00', description: '入間聲優活動 開演', category: 'event', locationId: 'kogakuin_arena', isHighlight: true, note: '16:00 就開場，不必一開場就進去' },
      { time: '19:30', description: '你好 恵馨閣（羽根つき餃子）', category: 'food', locationId: 'nihao_keishinkaku', isHighlight: true, note: '暫定。開到 24:00，散場多晚都吃得到。車站徒步 3 分，跟會場同一側' },
      { time: '20:40', description: '蒲田 → 大井町 20:55', category: 'transit', note: '以下時間依散場而定。中途在品川下車取回行李，再搭一站', origin: '蒲田', legs: [{ via: '京浜東北線', to: '品川' }, { via: '取行李後再搭', to: '大井町', arrive: '20:55' }] },
      { time: '21:05', description: '飯店入住、放行李', category: 'stay', locationId: 'ours_inn_hankyu', note: '今天全程帶著隨身物，行李晚上才進飯店' },
    ]
  },
  {
    date: '9/28',
    ...
    events: [
      { time: '07:30', description: '超商早餐', category: 'food', note: '08:05 就要出發，前一晚先買好比較保險' },
      ...
      { time: '11:10', description: 'Center Beef 関内（ビーフステーキライス）', category: 'food', locationId: 'center_beef', note: '11:10–12:00，現場排隊' },
      ...
      { time: '13:10', description: 'プラネタリア YOKOHAMA', category: 'event', locationId: 'planetaria', isHighlight: true, note: '～13:50。場次已確認，票 9/23 開賣要記得訂' },
      ...
      { time: '19:45', description: '鍋専科 鍋屋（涮涮鍋／壽喜燒）', category: 'food', locationId: 'nabeya_sakuragicho', isHighlight: true, note: '～20:45。コレットマーレ 7F，逛完同一棟上樓。夜景座位建議先訂 045-323-9081' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '09:30', description: 'B² 清澄白河本店 早餐', category: 'food', locationId: 'b_squared', note: '～09:55。9:00 開門。離門前仲町站比較近，可考慮提早一站下車' },
      { time: '10:00', description: '清澄庭園', category: 'spot', locationId: 'kiyosumi_garden', note: '10:00–10:50' },
      { time: '11:00', description: '深川釜匠（深川丼）', category: 'food', locationId: 'fukagawa_kamasho', isHighlight: true, note: '週二只做午市到 15:00，開店即到避開排隊' },
      { time: '12:05', description: '江戶土產屋高橋', category: 'spot', locationId: 'takahashi', note: '12:05–12:30。原本排早上，讓給 B² 早餐後移到午餐後' },
      { time: '12:35', description: '深川江戶資料館', category: 'spot', locationId: 'fukagawa_edo_museum', note: '12:35–13:20' },
      { time: '13:25', description: 'Cheese no Koe', category: 'food', locationId: 'cheese_no_koe', note: '13:25–13:45' },
      { time: '13:50', description: 'Babaghuri 清澄本店', category: 'spot', locationId: 'babaghuri', note: '13:50–14:10，走回清澄白河站約 5 分' },
