...
export const ITINERARY: DaySchedule[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: '18:30', description: '舞家晚餐', category: 'food' },
    ]
  },
  {
    date: '9/27',
    ...
    events: [
      { time: '09:00', description: '舞家早餐', category: 'food' },
      ...
      { time: '21:05', description: '阪急 OURS INN 入住、放行李', category: 'stay', locationId: 'ours_inn_hankyu', note: '今天全程帶著隨身物，行李晚上才進飯店' },
    ]
  },
  {
    date: '9/28',
