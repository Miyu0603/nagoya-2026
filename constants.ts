...
export const ITINERARY: DaySchedule[] = [
  {
    ...
    events: [
      ...
      { time: '15:40', description: '車站周邊小逛', category: 'spot', note: 'SHIRO 高島屋店、エスカ地下街、名鐵百貨、KITTE 名古屋' },
      { time: '16:40', description: '名古屋 → 名古屋城站', category: 'transit', note: '約 15 分', origin: '名古屋', legs: [{ via: '東山線', to: '栄' }, { via: '名城線', to: '名古屋城站' }] },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:15', description: '大須観音', category: 'spot', note: '12:15–12:35' },
      { time: '12:40', description: '七寺', category: 'spot', note: '徒步 3–5 分，12:40–12:55' },
      { time: '13:00', description: 'ロッキンロビン 大須店 午餐', category: 'food', locationId: 'rockin_robin', note: '13:00–13:50' },
      { time: '13:55', description: '万松寺', category: 'spot', note: '13:55–14:15' },
      { time: '14:20', description: '和栗モンブラン専門店 栗りん', category: 'food', locationId: 'kurin', isHighlight: true, note: '店內位子中午前多半滿了，走外帶窗口比較實際' },
      { time: '14:50', description: '三輪神社', category: 'spot', note: '14:50–15:05' },
      { time: '15:15', description: '若宮八幡社', category: 'spot', note: '徒步 12 分，15:15–15:35' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '15:50', description: '品川站寄行李、買 Suica', category: 'stay', note: '放到 9/27 傍晚，確認是 3 天制不是當日制' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:30', description: '下北澤 午餐＋逛街', category: 'food', note: '12:30–15:00' },
      { time: '15:00', description: '下北沢 → 品川 15:30', category: 'transit', origin: '下北沢', legs: [{ via: '井の頭線', to: '渋谷' }, { via: '山手線', to: '品川', arrive: '15:30' }] },
      { time: '15:35', description: '品川取行李', category: 'stay' },
      { time: '15:55', description: '阪急 OURS INN 入住、放行李', category: 'stay', locationId: 'ours_inn_hankyu', note: '順路先丟行李，晚上不用再繞回品川' },
      { time: '16:15', description: '大井町 → 蒲田 16:23', category: 'transit', note: '西口出來官網寫徒步 2 分，抓 5 分就很夠', origin: '大井町', legs: [{ via: '京浜東北線', to: '蒲田', arrive: '16:23' }, { via: '西口徒步', to: '片柳アリーナ' }] },
      { time: '17:00', description: '入間聲優活動', category: 'event', locationId: 'kogakuin_arena', isHighlight: true, note: '16:00 開場，不必一開場就進去' },
      { time: '19:30', description: '鳴門鯛焼本舗 蒲田駅前店', category: 'food', locationId: 'naruto_taiyaki', note: '活動結束後順路，時間依散場而定' },
    ]
  },
  {
    date: '9/28',
    ...
    events: [
      ...
      { time: '15:45', description: 'MARK IS みなとみらい', category: 'spot', locationId: 'mark_is', note: '15:45–16:15' },
      { time: '16:20', description: 'World Porters：JUMP SHOP、Snoopy Town', category: 'spot', locationId: 'world_porters', note: '16:20–16:50' },
      { time: '17:00', description: 'Sky Garden 69F', category: 'spot', locationId: 'sky_garden', isHighlight: true, note: '日落約 17:28，這個時間不要動' },
      { time: '18:15', description: 'コレットマーレ(.st)、CIAL 桜木町(Pensta)', category: 'spot', note: '18:15–18:40' },
      { time: '18:45', description: 'YOKOHAMA AIR CABIN', category: 'spot', locationId: 'air_cabin', note: 'A 往復後回桜木町吃飯 / B 單程過去逛古著並在當地吃' },
      { time: '20:30', description: '桜木町 → 大井町 21:05', category: 'transit', origin: '桜木町', legs: [{ via: '京浜東北線 直達', to: '大井町', arrive: '21:05' }] },
    ]
  },
  {
    date: '9/29',
    ...
    events: [
      ...
      { time: '16:40', description: '阿美橫町、晚餐', category: 'food' },
      { time: '17:40', description: 'Skyliner 京成上野發', category: 'transit', isHighlight: true },
