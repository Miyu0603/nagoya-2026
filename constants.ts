...
export const ITINERARY: DaySchedule[] = [
  {
    ...
    events: [
      ...
      { time: '16:40', description: '名古屋 → 名古屋城站', note: '約 15 分', origin: '名古屋', legs: [{ via: '東山線', to: '栄' }, { via: '名城線', to: '名古屋城站' }] },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '10:40', description: '国立 → 豪徳寺 11:30', origin: '国立', legs: [{ via: '中央線快速', to: '新宿', arrive: '11:10' }, { via: '小田急', to: '豪徳寺', arrive: '11:30' }] },
      { time: '11:35', description: '豪德寺（招財貓）', locationId: 'gotokuji', note: '11:35–12:10' },
      { time: '12:15', description: '豪徳寺 → 下北沢 12:20', note: '2 站', origin: '豪徳寺', legs: [{ via: '小田急', to: '下北沢', arrive: '12:20' }] },
      { time: '12:30', description: '下北澤 午餐＋逛街', note: '12:30–15:00' },
      { time: '15:00', description: '下北沢 → 品川 15:30', origin: '下北沢', legs: [{ via: '井の頭線', to: '渋谷' }, { via: '山手線', to: '品川', arrive: '15:30' }] },
      { time: '15:35', description: '品川取行李' },
      { time: '15:55', description: '阪急 OURS INN 入住、放行李', locationId: 'ours_inn_hankyu', note: '順路先丟行李，晚上不用再繞回品川' },
      { time: '16:15', description: '大井町 → 蒲田 16:23', note: '下車後步行 10 分到會場', origin: '大井町', legs: [{ via: '京浜東北線', to: '蒲田', arrive: '16:23' }, { via: '步行 10 分', to: '片柳アリーナ' }] },
  ...
  },
  {
    ...
    events: [
      { time: '08:05', description: '大井町 → 新羽 08:53', origin: '大井町', legs: [{ via: '京浜東北線', to: '横浜', arrive: '08:28' }, { via: 'ブルーライン', to: '新羽', arrive: '08:53' }] },
      { time: '09:00', description: '西方寺', locationId: 'saihoji', note: '彼岸花季末段，09:00–09:25' },
      { time: '09:33', description: '新羽 → 桜木町 09:55', origin: '新羽', legs: [{ via: 'ブルーライン', to: '桜木町', arrive: '09:55' }] },
      ...
      { time: '12:40', description: '元町・中華街 → 新高島 12:52', origin: '橫濱中華街', legs: [{ via: '步行 5 分', to: '元町・中華街駅' }, { via: 'みなとみらい線', to: '新高島', arrive: '12:52' }] },
      ...
      { time: '15:35', description: '横浜 → みなとみらい 15:39', origin: '横浜', legs: [{ via: 'みなとみらい線', to: 'みなとみらい', arrive: '15:39' }] },
      ...
      { time: '20:30', description: '桜木町 → 大井町 21:05', origin: '桜木町', legs: [{ via: '京浜東北線 直達', to: '大井町', arrive: '21:05' }] },
    ]
  },
  {
    date: '9/29',
    ...
    events: [
      ...
      { time: '08:50', description: '大井町 → 清澄白河 09:25', origin: '大井町', legs: [{ via: '京浜東北線', to: '浜松町' }, { via: '大江戸線（大門）', to: '清澄白河', arrive: '09:25' }] },
      ...
      { time: '14:15', description: '清澄白河 → 上野広小路 14:35', origin: '清澄白河', legs: [{ via: '半蔵門線', to: '三越前' }, { via: '銀座線', to: '上野広小路', arrive: '14:35' }] },
