...
export const ITINERARY: DaySchedule[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: '15:50', description: '抵達片柳アリーナ', category: 'transit', locationId: 'kogakuin_arena', note: '西口徒步 2 分。入口在 2 号館，電扶梯往下：B3 是 2 樓席、B4 是搖滾區' },
      { time: '16:00', description: '開場', category: 'event', note: '不必一開場就進去，周邊可以先晃' },
      { time: '17:00', description: '入間聲優活動 開演', category: 'event', locationId: 'kogakuin_arena', isHighlight: true },
      { time: '19:30', description: '鳴門鯛焼本舗 蒲田駅前店', category: 'food', locationId: 'naruto_taiyaki', note: '以下時間全依散場而定' },
      { time: '19:50', description: '蒲田 → 大井町 20:05', category: 'transit', note: '中途在品川下車取回行李，再搭一站', origin: '蒲田', legs: [{ via: '京浜東北線', to: '品川' }, { via: '取行李後再搭', to: '大井町', arrive: '20:05' }] },
