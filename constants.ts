...
export const ITINERARY: DaySchedule[] = [
  ...
  },
  {
    ...
    links: [{ label: '逛街地圖', url: 'https://claude.ai/artifact/MA1VBs7Wn3Db4iaSWRkeFw' }],
    events: [
      ...
      { time: '16:20', description: 'World Porters 3F 古著', category: 'spot', locationId: 'world_porters', note: '16:20–16:50。JUMP SHOP 與 Snoopy Town 其實在地標塔那一區' },
